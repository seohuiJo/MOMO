			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="descript_wrap white-bg">
						<table border="1" class="table table-bordered">
							...
							<c:forEach var="msg" items="${list }">
								<tr>
									...
									<td>${msg.toId }</td>
									<td>
										<c:url var="mdetail" value="msgSendDetail.mo">
											<c:param name="msId" value="${msg.msId }" />
										</c:url>
										<a href="${mdetail }">${msg.msContent }</a>
									</td>
									<td>${msg.msCreateDate }</td>
										<td>
									  <c:url var="msgSendDel" value="msgsendDel.mo">
									<c:param name="msId" value="${msg.msId }" />
								</c:url>
                                  <a href="${msgSendDel }" class="genric-btn danger-border radius">쪽지삭제</a>
                                  </td>
								</tr>
						...
						<!-- 	<a href="#" class="genric-btn danger-border radius">쪽지삭제</a> -->
						</div>
					</div>
				</div>
			</div>
