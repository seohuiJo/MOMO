						...
						<div class="section-top-border">
							<div class="mt-10">
								...
								<input type="text" name="userId" required class="single-input"
									placeholder="아이디" value="${member.userId }" readonly>
							</div>
							<div class="mt-10">
								<div>
									<p>
								...
								<input type="text" name="userName" required class="single-input"
							...
							<div class="mt-10">
								...
								<input type="text" name="birth" required class="single-input"
									placeholder="ex)930503" value="${member.birth }" readonly>
							</div>
							<div class="mt-10">
								<div>
									<p>
							...
							<div class="single-element-widget mt-30">
								<c:if test="${member.gender eq 'F' }">
									<div class="switch-wrap d-flex justify-content-between">
										<input type="radio" name="gender" value="F" checked onclick="return(false);">
										<p>여자</p>
										<input type="radio" name="gender" value="M" onclick="return(false);">
										<p>남자</p>
									</div>
								</c:if>
								...
								<c:if test="${member.gender eq 'M' }">
									<div class="switch-wrap d-flex justify-content-between">
										<input type="radio" name="gender" value="F" onclick="return(false);">
										<p>여자</p>
										<input type="radio" name="gender" value="M" checked onclick="return(false);">
										<p>남자</p>
									</div>
								</c:if>
							...
							<div class="mt-10">
								...
								<input type="text" name="nickName" required class="single-input"
									placeholder="닉네임" value="${member.nickName }" readonly>
							</div>
							<div class="mt-10">
								<div>
									<p>
								...
								<input type="text" name="phone" required class="single-input"
									placeholder="숫자만 입력" value="${member.phone }" readonly>
							</div>
							<div class="mt-10">
								<div>
									<p>
								...
								<input type="text" name="email" required class="single-input"
									placeholder="user@email.com" value="${member.email }" readonly>
							</div>

							<!-- 주소 입력 -->

							<c:forTokens var="address" items="${member.address }"
								...
								<c:if test="${status.index == 2 }">
									<div class="mt-10">
										...
										<input type="text" name="address2"
											class="postcodify_extra_info" value="${address }" readonly>
									</div>
								</c:if>
							</c:forTokens>
							...
							<div style="text-align: center;">
								...
								<a href= "${back }" class="genric-btn success radius">뒤로가기</a>
							</div>
						</div>
					</div>
				</div>
