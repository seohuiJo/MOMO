						...
						<div class="row align-items-center">
							...
							<div class="col-xl-6 col-lg-7">
								<div class="main-menu  d-none d-lg-block">
									<nav>
										<ul id="navigation">
											<li><a href="index.jsp">MOMO</a></li>
											<li><a href="melist.mo">나랑팀할래? <i class="ti-angle-down"></i></a>
												<ul class="submenu">
								...
								<div class="Appointment">
									<div class="main-menu d-none d-lg-block">
										<c:if test="${!empty loginUser}">
											...
											<nav>
												<ul id="navigation">
													<li><a href="#"><b>${loginUser.nickName }님</b>의 마이페이지 <i class="ti-angle-down"></i></a>
														<ul class="submenu">
														<c:if test="${loginUser.userId ne 'admin' }">
															<li><a href="profile.mo?userId=${loginUser.userId }">회원정보</a></li>
															<li><a href="msgList.mo?toId=${loginUser.userId }">쪽지함</a>
															<li><a href="candidate.html">팀원목록 </a></li>
															<li><a href="prList.mo?userId=${loginUser.userId }">장소 대관 내역 </a></li>
															<li><a href="svcWriterView.mo?userId=${loginUser.userId}">고객센터 </a></li>
