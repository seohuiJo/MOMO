		...
		<div class="catagory_area" style="height: 30px">
			<div class="container">
				<div class="row cat_search">
					...
					<div class="col-lg-3 col-md-5">
						<div class="single_input">
							<input type="text" placeholder="Search keyword" name="searchValue">
						</div>
					</div>
					...
					<div class="col-lg-3 col-md-5">
						<div class="job_btn">
							<a href="meWriterView.mo" class="boxed-btn3" style="background-color:skyblue;">나랑 팀할래? 글작성</a>
						</div>
					</div>
				</div>
			</div>
