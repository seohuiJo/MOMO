                                ...
                                <div class="section-top-border">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div id="career-area">
                                                <h4>경력사항</h4>
                                                <textarea name="career" class="form-control" cols="20" placeholder="이력사항을 입력하세요." required>
                                                </textarea>
                                            </div>
                                            <br>
                                            <div id="awards-area">
                                                <h4>수상내역</h4>
                                                <textarea name="awards" class="form-control" cols="20" placeholder="수상내역을 입력하세요." required>
                                                </textarea>
                                            </div>
                                            <br>
                                            <!-- 포트폴리오 -->
                                            <div id="portfolio-area">
	                                            <h4>포트폴리오</h4>
	                                            <textarea name="portfolio" class="form-control" cols="20" required placeholder="포트폴리오 내용을 입력하세요.">
	                                            </textarea>
	                                            <br>
