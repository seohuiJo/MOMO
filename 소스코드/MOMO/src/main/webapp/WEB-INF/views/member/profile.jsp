		...
		<div class="container box_1170">
			...
			<c:if test="${career != null }">
				<div class="section-top-border">
					<h3 class="mb-30" style="color:#4e4e4e;">경력사항</h3>
					<c:url var="cModifyView" value="cModifyView.mo">
	            		<c:param name="userId" value="${loginUser.userId }"/>
	            		<br>
	            	</c:url>
					<a href="${cModifyView}" class="genric-btn success radius">경력 사항 수정</a>
					
					<div class="row">
						<div class="col-lg-12">
							<br>
							<blockquote class="generic-blockquote">
								<textarea class="form-control" rows="10" cols="8" readonly>
									<c:if test="${career.career != null }">
										${career.career }
									</c:if> 
									<c:if test="${career == null }">
										${msgP }
	            ...
	            <div class="section-top-border">
					<h3 class="mb-30">포트폴리오</h3>
					<div class="row">
						<div class="col-lg-12">
							<blockquote class="generic-blockquote">
								<textarea name="portfolio" class="form-control" cols="20" required placeholder="포트폴리오 내용을 입력하세요." readonly>
									${career.portfolio }
								</textarea>
								<br>
