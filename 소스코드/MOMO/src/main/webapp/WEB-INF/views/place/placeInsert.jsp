         ...
         <div class="section-top-border">
            <div class="row">
               ...
               <div class="col-lg-8 col-md-8">
                  <h3 class="mb-30"><b>어디서 만날래</b> | 게시글 등록</h3>
                  <form action="pinsert.mo" method="post" enctype="Multipart/form-data">
							<div class="section-top-border">
								...
								<div class="mt-10">
									...
									<input type="text" name="pAcceptNum" required class="single-input" placeholder="ex) 6">
								</div>
								<div class="mt-10">
									<div>
										<p><i class="fa fa-thumb-tack" aria-hidden="true"></i> 가격</p>
									</div>
									<input type="text" name="pPrice" required class="single-input" placeholder="ex) 30000">
								</div>
