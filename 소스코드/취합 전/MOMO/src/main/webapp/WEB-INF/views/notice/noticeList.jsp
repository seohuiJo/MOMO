        ...
        <div class="container">
			...
			<td colspan="10">
				<c:if test="${ !empty loginUser }">
					<c:url var="ndetail" value="ndetail.mo" >
						<c:param name="nId" value="${n.nId }" />
						<c:param name="nCount" value="${n.nCount }" /> <!-- 쿼리스트링 -->
					</c:url>
			...
			<td colspan="2" align="center">${n.nWriter }</td>
			...
			<td align="center">${n.nCount }</td>
                        ...
                        <!-- 관리자로 로그인 했을 때만 글쓰기 버튼 표시 -->
                        <div class="submit-bt">
                        <c:if test="${!empty loginUser}"> 
                        	<c:if test="${loginUser.userId eq 'admin' }">
                            	<a href="nWrite.mo" class="genric-btn success radius">글쓰기</a>
                            </c:if>
                        </c:if>
                        </div>
                    </div>
