							...
							<table border="1" class="table table-bordered">
								<tr>
									...
									<td colspan="2">
										...
										<!-- 메세지 데이터 -->
										<input type="hidden" name="fromId" value="${loginUser.userId }"> <!-- 보내는 사람 / 나 -->
										<input type="text" class="form-control" name="toId" value="${we.wWriter }" readonly> <!-- 받는사람 / 위리스트 글쓴이 -->
									</td>
								</tr>
								<tr style="text-align: center;">
									<td colspan="4"><textarea cols="70" rows="10" class="form-control" name="msContent"></textarea></td>
								</tr>
							</table>
							<div class="submit-bt">
