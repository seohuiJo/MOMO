...
public class NotificationPageInfo {
	...
	public NotificationPageInfo() {}

	public NotificationPageInfo(int currentPage, int listCount, int pageLimit, int maxPage, int startPage, int endPage,
