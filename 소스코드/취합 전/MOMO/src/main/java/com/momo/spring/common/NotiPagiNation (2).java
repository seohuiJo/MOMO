...
public class NotiPagiNation {
	...
	public static NotificationPageInfo getPageInfo(int currentPage, int listCount, String userId) {
		// 페이지 정보를 담아줄 PageInfo 참조변수 선언
		NotificationPageInfo pi = null;
		...
		pi = new NotificationPageInfo(currentPage, listCount, pageLimit, maxPage, startPage, endPage, boardLimit, userId);
